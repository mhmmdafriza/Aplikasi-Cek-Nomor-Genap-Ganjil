...
# Deskripsi
Cek Nomor Genap/Ganjil adalah aplikasi sederhana yang memungkinkan pengguna untuk memeriksa apakah suatu angka merupakan bilangan genap atau ganjil. Aplikasi ini dirancang untuk digunakan dalam pembelajaran matematika dasar, sebagai alat bantu hitung sederhana, atau untuk memenuhi rasa ingin tahu pengguna tentang sifat bilangan. Dengan hanya memasukkan sebuah angka, aplikasi ini secara instan akan menampilkan apakah angka tersebut termasuk kategori genap atau ganjil.

## Coding Java Frame Aplikasi Cek Nomor Genap/Ganjil
```java
